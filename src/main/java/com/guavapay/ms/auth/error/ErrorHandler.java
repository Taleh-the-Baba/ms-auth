...
import com.guavapay.ms.auth.error.model.ErrorLevel;
import com.guavapay.ms.auth.error.model.RestErrorResponse;
import com.guavapay.ms.auth.error.model.ValidationError;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public RestErrorResponse handleUserNotFoundException(UserNotFoundException ex) {
        String uuid = UUID.randomUUID().toString();
        log.error("UserNotFoundException, uuid: {}, message: {}", uuid, ex.getErrorMessage());
        return new RestErrorResponse(
                uuid,
